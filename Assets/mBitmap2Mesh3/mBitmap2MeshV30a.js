...
//		uvs[i] = (vertices[i]+Vector3(3,1,0))/17;
	...
	var mRenderer:MeshRenderer = myobject.AddComponent.<MeshRenderer>() as MeshRenderer;
	var filter:MeshFilter = myobject.AddComponent.<MeshFilter>() as MeshFilter;
    myobject.transform.localPosition = pos;
...
//	finalSections[2] = worldToLocal * Matrix4x4.TRS(transform.position+Vector3.forward*(extrudeDepth*2), Quaternion.identity, Vector3(1,1,1));	
	...
	myobject.GetComponent.<Renderer>().material = gameObject.GetComponent.<Renderer>().material;
